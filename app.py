...
def main():
    ...
    if not st.session_state.fleet:
        ...
        truck_data = [
            {"name": "Comfort", "rarity": 1, "image": "static/images/Comfort.jpg", "ron_per_trip": 4, "breakdown_chance": "30%", "fuel_price": "2 $Ron", "engine": "Advanced Diesel"},
            {"name": "Highline", "rarity": 2, "image": "static/images/Highline.jpg", "ron_per_trip": 5, "breakdown_chance": "26%", "fuel_price": "2 $Ron", "engine": "Advanced Diesel"},
            {"name": "Shift", "rarity": 3, "image": "static/images/Shift.jpg", "ron_per_trip": 7, "breakdown_chance": "20%", "fuel_price": "2 $Ron", "engine": "Advanced Diesel"},
            {"name": "Electric", "rarity": 4, "image": "static/images/Electric.jpg", "ron_per_trip": 9, "breakdown_chance": "17%", "fuel_price": "1 $Ron", "engine": "Electric Engine"},
            {"name": "Autonomous", "rarity": 5, "image": "static/images/Autonomous.jpg", "ron_per_trip": 11, "breakdown_chance": "14%", "fuel_price": "1 $Ron", "engine": "Electric Engine"}
        ]
